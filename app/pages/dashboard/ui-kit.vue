  ...
  <div class="space-y-6">
    <header class="space-y-1">
      ...
      <p class="text-muted-foreground text-sm">
        Every primitive demonstrated in realistic contexts.
      </p>
    </header>
          ...
          <Popover>
            ...
            <PopoverContent class="w-56">
              ...
              <div class="space-y-1">
                ...
                <button class="flex w-full items-center gap-2 rounded px-2 py-1 text-xs hover:bg-accent text-destructive">
      ...
      <CardContent class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between">
            <Label
              for="ui-kit-switch-notifications"
              class="text-sm font-normal"
            >Notifications</Label>
            <Switch
              id="ui-kit-switch-notifications"
              default-checked
            />
          </div>
          <div class="flex items-center justify-between">
            <Label
              for="ui-kit-switch-dark-mode"
              class="text-sm font-normal"
            >Dark mode</Label>
        ...
        <CardContent>
          <Collapsible>
            ...
            <CollapsibleContent class="space-y-2 mt-2">
              <div class="rounded-md border px-3 py-2 text-xs font-mono">
                @radix-ui/primitives
              </div>
              <div class="rounded-md border px-3 py-2 text-xs font-mono">
                @radix-ui/colors
