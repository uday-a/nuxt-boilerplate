    ...
    <Card>
      ...
      <CardContent class="space-y-4">
        <div class="grid gap-2">
          ...
          <Input id="ws-name" v-model="workspaceName" />
        </div>
        <div class="grid gap-2">
          ...
          <div class="flex">
            ...
            <Input id="ws-url" v-model="workspaceUrl" class="rounded-l-none" />
          </div>
        ...
        <div class="grid gap-2">
          ...
          <Input id="ws-email" v-model="supportEmail" type="email" />
        </div>
      </CardContent>
    </Card>
      ...
      <CardContent class="space-y-4">
        <div class="grid gap-2">
          ...
          <div class="flex items-center gap-3">
            <input type="color" v-model="brandColor" class="size-10 cursor-pointer rounded-md border" />
            <Input v-model="brandColor" class="font-mono text-sm w-32" />
          </div>
